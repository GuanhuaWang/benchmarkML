...
def main(_):
  ...
  if FLAGS.job_name == "ps":
    ...
    with sv.prepare_or_wait_for_session(server.target) as sess:
      ...
      print(sess.run(accuracy, feed_dict={x:minist.test.images,y_:mnist.test.labels}))
...
if __name__ == '__main__':
  ...
  parser.add_argument("--worker_hosts", type = str, default="", help = "Comma-separaed list of hostname:port pairs")
